  ...
  return (
    <main>
      ...
      <div className="flex w-full flex-col md:flex-row container md:w-5/6 mx-auto md:mt-20 mt-4 flex-1 items-center">
        ...
        <div id="about-words-container" className="mt-8 md:mt-0 md:ml-24 container mx-auto text-secondary flex flex-col md:justify-left flex-1 ">
        <FadeInSection fadeDuration={300} slideDuration={300} distance="5vh">
          <h1 className="ml-8 md:ml:0 text-3xl font-semibold">About Me</h1>
          </FadeInSection>
          <FadeInSection fadeDuration={300} slideDuration={300} distance="5vh">
